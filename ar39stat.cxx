...
*/
    ...
    TParameter<int>    p_integral_model("integral_model",integral_model);
    TParameter<double> p_integral_data ("integral_data", integral_data );
    TParameter<int>    p_best_activity ("best_activity", best_activity );
